...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Bollywoodcoin: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Bollywoodcoin: 840k blocks in ~4 years
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Bollywoodcoin: Special short-term limits to avoid 10,000 BDB lock limit:
