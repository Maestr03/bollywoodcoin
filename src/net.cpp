...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bollywoodcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bollywoodcointools.com", "dnsseed.bollywoodcointools.com"},
    {"bollywoodcoinpool.org", "dnsseed.bollywoodcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"bollywoodcointools.com", "testnet-seed.bollywoodcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bollywoodcoin is probably already running."), addrBind.ToString().c_str());
        else
